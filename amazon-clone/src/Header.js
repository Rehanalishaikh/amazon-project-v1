...
function Header() {
    return (
        ...
        <Link to="/"> 
          ...
          <LocationOnOutlinedIcon className="header--location"/>
      ...
      <span className="header--optionLineTwo">Select your address</span>
          ...
          <img className="flag" src="https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Flag_of_India.svg/1350px-Flag_of_India.svg.png"
             alt="indianflag"/>
